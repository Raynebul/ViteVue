    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input placeholder="Введите логин или почту" type="text" name="username" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
        </div>

        <div class="input-group input-group-sm mb-3">
          <span class="input-group-text" id="inputGroup-sizing-sm"></span>
          <input placeholder="Введите пароль" type="text" name="password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
        </div> -->
            ...
            <!-- <div class="form-floating mb-3">
          <input name="password" type="email" class="form-control" id="floatingInput" placeholder="Password">
